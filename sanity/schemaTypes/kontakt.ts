...
export const kontakt = defineType({
	...
	fields: [
		...
		defineField({
			name: "daneTytul",
			title: "Nagłówek nad danymi do przelewu",
			type: "string",
			group: "dane",
			description: "Np. „Dane do przelewu”. Stoi w stopce, nad numerami niżej.",
		}),
		defineField({
			name: "nip",
			title: "NIP",
			type: "string",
			group: "dane",
			description: "Wpisz tak, jak ma się wyświetlać, np. „000-000-00-00”. ",
		}),
		defineField({
			name: "krs",
			title: "KRS",
			type: "string",
			group: "dane",
			description: "Numer w Krajowym Rejestrze Sądowym",
		}),
		defineField({
			name: "regon",
			title: "REGON",
			...
			group: "dane",
			description:
				"Numer statystyczny z GUS, dziewięć cyfr. Inny niż KRS i inny niż NIP.",
		}),
		defineField({
			name: "konto",
			...
			group: "dane",
			description:
				"Pogrupuj cyfry spacjami, np. „00 0000 0000 0000 0000 0000 0000” - łatwiej przepisać do przelewu.",
		}),
		defineField({
			name: "kanalyTytul",
